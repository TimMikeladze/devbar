...
export function CaptureOverlay({
	...
	return (
		<div
			data-devbar="capture-overlay"
			onMouseDown={onMouseDown}
			onMouseMove={onMouseMove}
			onMouseUp={onMouseUp}
			className={`devbar-overlay ${captureMode === "region" ? "devbar-overlay-crosshair" : ""}`}
		>
			{captureMode === "region" && selectionRect && selectionRect.width > 0 && (
				<>
					<div
						className="devbar-region-selection"
						style={{
					...
					/>
					<div
						className="devbar-region-dimensions"
						style={{
			...
			{captureMode === "capturing" && <div className="devbar-capture-status">Capturing...</div>}

			{captureMode === "note" && (
				<div data-devbar="note-input" className="devbar-capture-note">
					<div className="devbar-capture-note-title">Screenshot captured</div>
					<input
						type="text"
