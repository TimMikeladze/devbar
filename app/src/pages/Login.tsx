...
export function LoginPage() {
	...
	useEffect(() => {
		const titles = {
			signin: "Sign In – devbar.sh",
			signup: "Sign Up – devbar.sh",
			forgot: "Reset Password – devbar.sh",
		};
	...
	const headings = {
		...
		signup: { title: "Create account", sub: "Get started with devbar" },
		...
		<div className="min-h-screen bg-bg login-glow flex items-center justify-center px-5">
			<div className="w-full max-w-[380px] fade-up">
				...
				<div className="text-center mb-10">
					...
					>
						<LogoMark />
						devbar<span className="text-muted">.dev</span>
					</a>
				</div>
