...
function CheckIcon() {
	return (
		<svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="text-emerald shrink-0 mt-[2px]">
	...
	return (
		<div className="grid sm:grid-cols-3 gap-4">
			...
			<div className="pricing-card flex flex-col border border-accent/30 rounded-lg p-5 sm:p-6 relative">
				<span className="absolute -top-2.5 left-4 px-2 py-0.5 text-[11px] font-semibold bg-accent text-white rounded-full tracking-wide">Popular</span>
				<div className="mb-4">
